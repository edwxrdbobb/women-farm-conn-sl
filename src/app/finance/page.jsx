...
export default function FinancialSupport() {
  const grants = [
    { title: 'Sierra Leone Agricultural Fund', description: 'Government grant to boost food production', image: '/grant-1.jpg' },
    { title: 'Salone Access to Finance', description: 'Project to empower over 500,000 Farmers', image: '/grant-2.jpg' },
    { title: 'Adaptation Fund', description: 'Climate resilience in Cocoa and Rice sectors', image: '/grant-3.jpg' },
  ]
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <section className="relative h-[400px]">
          <Image src="/financial-hero.jpg" alt="Financial Support Hero" layout="fill" objectFit="cover" priority />
